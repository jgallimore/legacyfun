   ...
   /** 
    ...
    throws RemoteException {
    	...
    	if (Log.doTrace())
    	    ...
    	    return (new org.daytrader.direct.TradeDirect()).completeOrderOnePhase(orderID);
        } catch (Exception e){
            throw new RemoteException(e.getMessage(),e);
        }
    }
	...
	throws RemoteException {
		...
		(new org.daytrader.direct.TradeDirect()).cancelOrderOnePhase(orderID);
        } catch(Exception e){
            throw new RemoteException(e.getMessage(),e);
        }
	}
	...
	throws Exception
	{
		...
		// Reset Trade
		return new org.daytrader.direct.TradeDirect().resetTrade(deleteAll);
	}
